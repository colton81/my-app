                        ...
                        <div className="offcanvas-inner-content">
                            ...
                            <div className="offcanvas-widget-area">
                                ...
                                <div className="header-contact-info">
                                    ...
                                    <li><i className="ion-android-phone-portrait" /> <a href="tel://12452456012">(281) 748  </a></li>
                                    <li><i className="ion-android-mail" /> <a href="mailto:info@yourdomain.com">sales@houstonprocessanddesign.com</a></li>
                                    </ul>
                                </div>
                                </div>
